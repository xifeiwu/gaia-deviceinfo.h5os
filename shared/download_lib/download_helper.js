 ...
 *
 *   <!-- <script src="shared/mime_mapper/mime_mapper.js"></script> -->
 *   <!-- <script src="shared/download_lib/download_store.js"></script> -->
...
var DownloadHelper = (function() {
  ...
  */
  ...
  LazyLoader.load('shared/settings_listener/settings_listener.js', function settingsLoaded() {
  ...
  */
          ...
          default:
            ...
            storeDeleteReq.onsuccess = function store_onsuccess() {
              ...
              if (download.state === 'succeeded') {
                LazyLoader.load(['/shared/download_lib/download_store.js'],
                  function() {
  ...
  function handlerError(error, download, cb) {
    LazyLoader.load('shared/download_lib/download_ui.js', (function loaded() {
      var req;
