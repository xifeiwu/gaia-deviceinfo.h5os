...
module.exports = component.register('gaia-switch', {
  ...
  created: function() {
    ...
    this._uninit = this.classList.contains('uninit');
    this.classList.remove('uninit');
  ...
  onClick: function(e) {
    ...
    if (this.disabled || this.drag.dragging) {
      return;
    }
